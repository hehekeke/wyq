...
class jpush {
    private $_masterSecret = '8a4bfa1e404e89f8664a8757';
    private $_appkeys = '81c4e282c8261961e39964a9';
     ...
     */
    function send($sendno = 0,$receiver_type = 1, $receiver_value = '', $msg_type = 1, $msg_content = '', $platform = 'android',$s=0) {
...
//$msg_content = json_encode(array('n_builder_id'=>0,'n_title'=>'标题', 'n_content'=>'我是l李浩!','n_extras'=>array('ex'=>'这是附加的字段!')));
//
////$j=new jpush('61eda650c6d3a52780a5db9b','81c4e282c8261961e39964a9');
//$j=new jpush();
