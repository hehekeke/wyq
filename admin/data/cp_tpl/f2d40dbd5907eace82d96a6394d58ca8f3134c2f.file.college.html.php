<?php /* Smarty version Smarty-3.1.14, created on 2014-11-27 11:27:59
         compiled from "admin\tpl\basedata\college.html" */ ?>
<?php /*%%SmartyHeaderCode:134154769a3f6f7e99-38779908%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2d40dbd5907eace82d96a6394d58ca8f3134c2f' => 
    array (
      0 => 'admin\\tpl\\basedata\\college.html',
      1 => 1412909654,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '134154769a3f6f7e99-38779908',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54769a3f7a7b46_73280903',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54769a3f7a7b46_73280903')) {function content_54769a3f7a7b46_73280903($_smarty_tpl) {?><?php if (!is_callable('smarty_function_page')) include 'C:\\Myphp\\apache\\htdocs\\nkgn\\been/View/plugins\\function.page.php';
...
/mannkgn.php/basedata/delcollege/id/"+id,
			type:'POST',
			async:false,
			dataType:"json",
...
/mannkgn.php/basedata/addcollege" >添加学院</a>
	</div>
	<div id="info" style=" margin-top:20px; margin-left:10px;">
		...
		<table id="mytable" cellspacing="0" >  
		  <tr>  
		    ...
		    <th scope="col" width="400px" >学院名称</th> 
...
?>
		  <tr id="college-<?php echo $_smarty_tpl->tpl_vars['list']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['ll']['index']]['college_id'];?>
">  
		    <td style="border-left:1px solid #adceff;" ><?php echo $_smarty_tpl->tpl_vars['list']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['ll']['index']]['college_id'];?>
</td>
		    <td><?php echo $_smarty_tpl->tpl_vars['list']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['ll']['index']]['college_name'];?>
</td>
		    <td>
		    	<a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/mannkgn.php/basedata/editcollege/id/<?php echo $_smarty_tpl->tpl_vars['list']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['ll']['index']]['college_id'];?>
">修改</a>&nbsp;
		    	<a href="#" onclick="del(<?php echo $_smarty_tpl->tpl_vars['list']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['ll']['index']]['college_id'];?>
)" return false;>删除</a>
		    </td>
		  </tr>  
		  <?php endfor; else: ?>
		...
		<?php echo smarty_function_page(array('info'=>$_smarty_tpl->tpl_vars['list']->value,'web_url'=>$_smarty_tpl->tpl_vars['web_url']->value,'url'=>"/mannkgn.php/basedata/getcollegelist"),$_smarty_tpl);?>
