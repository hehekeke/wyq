<?php /* Smarty version Smarty-3.1.14, created on 2014-11-28 14:37:51
         compiled from "admin\tpl\activity\viewactivity.html" */ ?>
<?php /*%%SmartyHeaderCode:673554780c927be8c9-59300121%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd69daeb55f5a35dc2bee10ddbe3ebdccde94c2f7' => 
    array (
      0 => 'admin\\tpl\\activity\\viewactivity.html',
      1 => 1417156665,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '673554780c927be8c9-59300121',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_54780c928c4484_70035001',
  'variables' => 
  array (
    'web_url' => 0,
    'id' => 0,
...
<?php if ($_valid && !is_callable('content_54780c928c4484_70035001')) {function content_54780c928c4484_70035001($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
/common/admin/images/title_bg1.jpg">当前位置:查看活动页面  
							<a style="margin-left:1000px;" href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/mannkgn.php/activity/Getactivitylist">返回</a></TD></TR>
...
<font>
       		...
       		<tr>
				...
				<td height="130" colspan="2">&nbsp;
					...
					<?php echo $_smarty_tpl->tpl_vars['activityInfo']->value['activity_content'];?>
...
" />人
			...
			<tr>
   				<td height="40"><div align="right">关键词</div></td>
       	 		<td height="40" colspan="2">&nbsp;
       	 			<input id="activity_keywords" type="text" name="activity_keywords" value="<?php echo $_smarty_tpl->tpl_vars['activityInfo']->value['activity_keywords'];?>
" style="width:340px;height:20px;" />
			...
			<tr>
   				<td height="40"><div align="right">负责人</div></td>
       	 		<td height="40" colspan="2">&nbsp;
       	 			<input id="activity_duty_preson" type="text" value="<?php echo $_smarty_tpl->tpl_vars['activityInfo']->value['activity_duty_preson'];?>
" name="activity_duty_preson" style="width:340px;height:20px;" />
				</td>
			</tr>
