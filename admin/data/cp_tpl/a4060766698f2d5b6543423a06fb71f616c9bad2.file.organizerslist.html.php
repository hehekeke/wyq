<?php /* Smarty version Smarty-3.1.14, created on 2014-11-27 11:22:06
         compiled from "admin\tpl\activitymanage\organizerslist.html" */ ?>
<?php /*%%SmartyHeaderCode:4584547698de866603-15605655%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a4060766698f2d5b6543423a06fb71f616c9bad2' => 
    array (
      0 => 'admin\\tpl\\activitymanage\\organizerslist.html',
      1 => 1412909666,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4584547698de866603-15605655',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_547698de925cb1_10356430',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_547698de925cb1_10356430')) {function content_547698de925cb1_10356430($_smarty_tpl) {?>﻿<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    <TR height=28><TD background=images/title_bg1.jpg>当前位置:主办方维护</TD></TR>
...
/mannkgn.php/ActivityManage/addorganizers" >添加主办方</a>
</div>
<div id="info" style=" margin-left:10px;">
    ...
    <table id="mytable" cellspacing="0" >
        <tr>
            ...
            <th scope="col" width="150px" >主办方名称</th>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['ut']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['organizerslists']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
        <tr >
            ...
            <td style="border-left:1px solid #adceff;" ><?php echo $_smarty_tpl->tpl_vars['organizerslists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ut']['index']]['organizers_id'];?>
</td>
            <td><?php echo $_smarty_tpl->tpl_vars['organizerslists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ut']['index']]['organizers_name'];?>
</td>
            <td>
                &nbsp;&nbsp;
                [<a onClick="return confirm('确认要删除角色：<?php echo $_smarty_tpl->tpl_vars['organizerslists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ut']['index']]['organizers_name'];?>
？');" href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/mannkgn.php/ActivityManage/organizerslist/do/del/id/<?php echo $_smarty_tpl->tpl_vars['organizerslists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ut']['index']]['organizers_id'];?>
">删除</a>]
                &nbsp;&nbsp;
                [<a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/mannkgn.php/ActivityManage/modifyorganizers/id/<?php echo $_smarty_tpl->tpl_vars['organizerslists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ut']['index']]['organizers_id'];?>
" >修改</a>]
            </td>
        </tr>
        <?php endfor; else: ?>
        <tr >
            <th class="spec" colspan="5">暂无主办方！</td>
        </tr>
        <?php endif; ?>
    </table>
</div>
