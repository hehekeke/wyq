<?php /* Smarty version Smarty-3.1.14, created on 2014-10-27 14:34:42
         compiled from "admin\tpl\addactivity\editactivity.html" */ ?>
<?php /*%%SmartyHeaderCode:2355544de7828191a0-72015809%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '851bec13319791c232085e7a192819681b73344a' => 
    array (
      0 => 'admin\\tpl\\addactivity\\editactivity.html',
      1 => 1412909666,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2355544de7828191a0-72015809',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_544de7829a0607_35346703',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544de7829a0607_35346703')) {function content_544de7829a0607_35346703($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
/common/admin/images/title_bg1.jpg">当前位置:修改活动</TD></TR>
...
<font>
       		...
       		<tr>
				...
				<td height="130" colspan="2">&nbsp;
					<textarea id="content" name="activity_content" rows="15" cols="12" style="width:600px" ><?php echo $_smarty_tpl->tpl_vars['activityInfo']->value['activity_content'];?>
</textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
   				<td height="40"><div align="right">专业性级别</div></td>
					...
					<select id = "activity_level" name = "activity_level">
						<?php if ($_smarty_tpl->tpl_vars['activityInfo']->value['activity_level']==0){?><option value="0" selected>0</option><?php }else{ ?><option value="0">0</option><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['activityInfo']->value['activity_level']==1){?><option value="1" selected>1</option><?php }else{ ?><option value="1">1</option><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['activityInfo']->value['activity_level']==2){?><option value="2" selected>2</option><?php }else{ ?><option value="2">2</option><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['activityInfo']->value['activity_level']==3){?><option value="3" selected>3</option><?php }else{ ?><option value="3">3</option><?php }?>
       	 			</select>
				</td>
			</tr>
			<tr>
...
/mannkgn.php/addactivity/ActivityList"><input id="back" type="button" name="back" value="返回" style="width:80px;height:30px;" /></a>
            	</td>
    		</tr>
    	</form>
	</table>
